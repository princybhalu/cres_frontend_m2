...
export const getUserByEmail = (email) =>  {
    return  http.get({
      url: 'https://34.196.219.106:4000/user?email=' + email,
  ...
  export const sendInviteToUser = (body) => {
    return http.post({
      url: "https://34.196.219.106:4000/user/invite",
      data: body,
      messageSettings : {}
    })
  }
  ...
  export const updatePermissionOfUserForProject = (body , projectId , userId) => {
    ...
    return http.put({
      url: "https://34.196.219.106:4000/permission",
      data: body ,
      config: {
        headers:{
  ...
  export const getUsersListByIds = (body) => {
    return http.post({
      url: "https://34.196.219.106:4000/user/get-users-by-ids",
      data: body,
    })
  }
...
export const activateUser = (body) => {
  ...
  return http.post({
    url: "https://34.196.219.106:4000/user/activate",
    data:body ,
    messageSettings : {}
  })
}
